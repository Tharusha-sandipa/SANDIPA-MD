/*
created by tharusha sandipa 🕵
contact me 94740326138 ♻️
© Copy coder alert ⚠
*/
...
console.log("SESSION ID DOWNLOADED COMPLETED ✅")
})})}
...
console.log("CONNECTING SANDIPA-MD BOT🧬...");
...
console.log('SANDIPA-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*SANDIPA-MD WABOT CONNECTED SUCCESSFULLY ✅*\n\n*PREFIX: [${prefix}]*\n\n*BOT OWNER:* https://wa.me/+94726268471?text=Hi☺️👋`;
...
app.get("/", (req, res) => {
res.send("HEY, SANDIPA-MD STARTED ✅");
});
